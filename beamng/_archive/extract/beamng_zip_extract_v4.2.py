#!/usr/bin/env python3
# python 'C:\Users\Administrator\projects\BeamNG\beamng\extract\beamng_zip_extract_v4.2.py' -r 'D:\__BeamNG__\___mods___' --out-base-dir 'G:\My Drive\__BeamNG__\____directory-extract____\output'
# python 'C:\Users\Administrator\projects\BeamNG\beamng\extract\beamng_zip_extract_v4.2.py' -r 'M:\__BeamNG__\___mods___' --out-base-dir 'G:\My Drive\__BeamNG__\____directory-extract____\output'
# python 'C:\Users\Administrator\projects\BeamNG\beamng\extract\beamng_zip_extract_v4.2.py' -r 'C:\__BeamNG__\___mods___' --out-base-dir 'G:\My Drive\__BeamNG__\____directory-extract____\output'
# python 'C:\Users\Administrator\projects\BeamNG\beamng\extract\beamng_zip_extract_v4.2.py' -r 'R:\__BeamNG__\___mods___' --out-base-dir 'G:\My Drive\__BeamNG__\____directory-extract____\output'

# python 'beamng_zip_extract_v4.2.py' -r 'D:\__BeamNG__\___mods___' --out-base-dir 'G:\My Drive\__BeamNG__\____directory-extract____\output'
# python 'beamng_zip_extract_v4.2.py' -r 'M:\__BeamNG__\___mods___' --out-base-dir 'G:\My Drive\__BeamNG__\____directory-extract____\output'
# python 'beamng_zip_extract_v4.2.py' -r 'C:\__BeamNG__\___mods___' --out-base-dir 'G:\My Drive\__BeamNG__\____directory-extract____\output'
# python 'beamng_zip_extract_v4.2.py' -r 'R:\__BeamNG__\___mods___' --out-base-dir 'G:\My Drive\__BeamNG__\____directory-extract____\output'
...
def path_has_excluded_dir(internal_path: str, exclude: set) -> bool:
    """
    Return True if ANY directory segment (not just top-level) in the internal zip path
    matches an excluded directory name.
    Example: levels/MyMap/art/props/info.json -> excluded if 'art' in exclude.
    """
    p = internal_path.replace("\\", "/").lstrip("/")
    parts = [x.lower() for x in p.split("/") if x]
    if len(parts) <= 1:
        return False  # no directories
    for d in parts[:-1]:  # ignore filename
